    function entrar() {
        ...
        fetch("/api/usuarios/autenticar", {
            ...
            .then(data => {
                ...
                if (data.success) {
                    alert("Login realizado com sucesso, agora você terá que realizar a troca de senha obrigatória por questão de segurança!");
                    ...
                    sessionStorage.PRECISA_ALTERAR_SENHA = 'true';
